...
int agendarexec(){
    ...
    execs[ids].status = false; //garante que o status vai estar em false inicialmente
    execs[ids].id = ids;
    aux = ids;
    ids++;
    return execs[aux].id ; //retorna o id da execuçao
}
